...
function ChordMaker({ chord, base, scaleNotes, setChordNotes, setChordNotesKey }) {
    ...
    function displayChordCorrectOrder(chordNotes) {
        ...
        for (let i = 0; i < chordNotes.length; i++) {
            ...
            let modifyNote = noteCompare.indexOf(notePrefix) < noteCompare.indexOf(comparedNote);
