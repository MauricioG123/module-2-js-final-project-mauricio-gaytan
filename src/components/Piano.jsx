...
function Piano({ scaleNotes, chordNotes, enharmonicConversion, chordNotesKey }) {
    ...
    function displayScaleCorrectOrder() {
        for (let i = 0; i < scaleNotes.length; i++) {
            ...
            let modifyNote = noteCompare.indexOf(notePrefix) < noteCompare.indexOf(scaleNotes[0][0]);
